...
# File "/Users/nakayatakanori/Desktop/Streamlit  X    Plotly ---------------------------------->  Dashboard/Dashborad_ex/db_app.py", line 19
  # df_pref_map['一人当たり賃金（相対値）']=((df_pref_map['一人当たり賃金（万円）']df_pref_map['一人当たり賃金（万円）'].min())/(df_pref_map['一人当たり賃金（万円）'].max()df_pref_map['一人当たり賃金（万円）'].min()))view=pdk.ViewState(
